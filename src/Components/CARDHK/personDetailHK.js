...
import Details from './person/dataInfoHK';
...
export function PersonDetailsHK(props) {
  const { id } = useParams();
        ...
        <div className='cardDetail'>
          ...
          <div className='cardDetail-body'>
            ...
            <div className='cardDetail-bodyStatement'>
              ...
              <br />
              <p>Halo! Nama saya {personDetails.name}, Saya telah bekerja selama 5 tahun dalam bidang housekeeping, saya adalah ahli dalam membersihkan, merapikan, juga merawat rumah anda!</p>
