...
import Details from './person/dataInfoWC';
...
export function PersonDetailsSM(props) {
  const { id } = useParams();
        ...
        <div className='cardDetail'>
          ...
          <div className='cardDetail-body'>
            ...
            <div className='cardDetail-bodyStatement'>
              ...
              <br />
              <p>Halo! Nama saya {personDetails.name}, Saya telah bekerja selama 5 tahun dalam bidang maintenance mobil, saya adalah ahli dalam perbaikan, instalasi, juga maintanence mobil anda!</p>
              <p>Saya akan menjamin kualitas pengerjaan, pelayanan dan juga kerapian dalam pengerjaan saya.</p>
            </div>
          </div>
        </div>
        <Ingfo
