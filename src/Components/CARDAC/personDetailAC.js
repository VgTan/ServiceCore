...
import Details from './person/dataInfoAC';
...
export function PersonDetailsAC(props) {
  const { id } = useParams();
        ...
        <div className='cardDetail'>
          ...
          <div className='cardDetail-body'>
            ...
            <div className='cardDetail-bodyStatement'>
              ...
              <br />
              <p>Halo! Nama saya {personDetails.name}, Saya telah bekerja selama 5 tahun dalam bidang Maintenance AC, saya adalah ahli dalam perbaikan, instalasi, juga maintanence AC anda!</p>
