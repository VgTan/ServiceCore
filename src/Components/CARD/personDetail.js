        ...
        <div className='cardDetail'>
          ...
          <div className='cardDetail-body'>
            ...
            <div className='cardDetail-bodyStatement'>
              ...
              <br />
              <p>Halo! Nama saya {personDetails.name}, Saya telah bekerja selama 5 tahun dalam bidang housekeeping, saya adalah ahli dalam perbaikan, instalasi, juga maintanence pipa hingga pompa toilet anda!</p>
